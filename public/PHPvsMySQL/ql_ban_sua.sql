...
--
-- Host: localhost:3306
-- Generation Time: Nov 19, 2022 at 02:06 PM
...
CREATE TABLE `ct_hoadon` (
  `So_hoa_don` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `Ma_sua` varchar(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `hang_sua` (
  `Ma_hang_sua` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `Ten_hang_sua` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `Dia_chi` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `Dien_thoai` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `hoa_don` (
  ...
  `Ma_khach_hang` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
('kh001', 'Khuất Thùy Phương', 1, 'A21 Nguyễn Oanh quận Gò Vấp', '0326593343', 'ktphuong@hcmuns.edu.vn'),
...
CREATE TABLE `loai_sua` (
  `Ma_loai_sua` varchar(3) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `Ten_loai` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `sua` (
  `Ma_sua` varchar(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `Ten_sua` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `Ma_hang_sua` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `Ma_loai_sua` varchar(3) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `Trong_luong` int NOT NULL,
  `Don_gia` int NOT NULL,
  `TP_Dinh_Duong` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `Loi_ich` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `Hinh` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
('AB1111', 'aboot_2', 'AB', 'SB', 400, 110000, 'vitamin', 'tăng cân', 'pokemon.jpg'),
