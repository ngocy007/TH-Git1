...
@section('main')
    ...
    <form action="../{{ $idTruyen }}/store" method="post" enctype="multipart/form-data"
        style="background-color: rgb(234, 238, 234); padding: 20px">
        @csrf
        <form>
            <div class="form-floating mb-4">
                <input type="text" id="TenChuong" class="form-control" placeholder="Tên chương" name="TenChuong" required>
